...
export const ArticleCard = ({ title, image, description, author, authorImage, date }: ArticleProps) => {
  return (
    <Link to={`/blog-post`}>
...
export const MiniArticleCard = ({ title,image,author}: Pick<ArticleProps, "title" | "image" | "author">) => {
  return (
