    ...
    return (
        <section className="">
            <div className="container mx-auto pb-8">
                <h3 className=" text-4xl font-semibold text-center">Simple and tasty recipes</h3>
                <p className="text-center text-gray-700 mt-8">Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut <br /> labore et dolore magna aliqut enim ad minim </p>
                <div className="grid grid-cols-3 items-center gap-16 mt-12">
                    <CardRecipe />
                    <CardRecipe />
                    <CardRecipe />
                    <CardRecipe />
...
const CardRecipe = () => {
    return (
      <div className="rounded-2xl bg-[#E0F7FA] px-4 py-6 font-sans shadow-lg">
