      ...
      <section className="px-4 md:px-0">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="w-full bg-white rounded-2xl p-2 h-fit flex flex-col sm:flex-row items-center gap-2 sm:gap-0 sm:justify-between mt-8 md:mt-12 border border-gray-300">
            ...
            />
            <Button size="lg" className="w-full sm:w-auto mt-2 sm:mt-0 py-4 md:py-6 px-6 md:px-12">
              Subscribe
            </Button>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="col-span-1 lg:col-span-2">
              <div className="flex flex-col md:flex-row gap-4">
                <div className="overflow-hidden rounded-xl md:rounded-2xl w-full md:w-2/4 min-h-[160px]">
                  <img
                    src={
                ...
                <div className="p-2 md:p-4 space-y-2 md:space-y-4 flex-1">
                  ...
                  <div className="flex items-center gap-2 md:gap-4 pr-0 md:pr-10">
                    ...
                    <div>
                      <p className="font-semibold text-xs md:text-base">John Smith</p>
                    </div>
            ...
            <div className="col-span-1">
              <h3 className="text-lg md:text-3xl font-semibold">Tasty Recipe</h3>
              <div className="mt-4 md:mt-8">
                <div className="grid grid-cols-2 gap-2 md:gap-4 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs md:text-sm text-gray-500">By John Smith</p>
                  </div>
                </div>
              </div>
