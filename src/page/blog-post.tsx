...
export default function BlogPost() {
  return (
    <Template recipeSection={true}>
      <div className="">
        <h1 className="text-2xl md:text-6xl font-semibold leading-tight text-center">
        ...
        <p className="max-w-2xl md:max-w-4xl px-4 md:px=0 mx-auto mt-6 md:mt-8 text-gray-500 text-center text-sm md:text-base">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Harum,
          aliquam? Blanditiis dicta dolorem nulla voluptatem dignissimos
          architecto ducimus ratione magni aspernatur quae, suscipit modi
          temporibus maxime ut rerum at voluptas.
        </p>
      </div>
      ...
      <div className="mt-8 md:mt-12 ">
        <div className="grid grid-cols-1 lg:grid-cols-3 mb-10 md:mb-20 gap-8 md:gap-12">
          <div className="col-span-1 lg:col-span-2 space-y-10 md:space-y-16">
            <div className="px-2 md:px-6">
              ...
              <p className="text-gray-500 mt-2 md:mt-4 text-sm md:text-base">
                ...
                adipisicing elit. Voluptatibus iure amet molestias, temporibus
                harum, earum odit perspiciatis, illo vero illum est cumque
                aliquam. Cum, eveniet eum porro ducimus rem fugit?
              </p>
            </div>
            <div className="px-2 md:px-6">
              <h2 className="text-xl md:text-3xl font-semibold">
            ...
            <div className="bg-gray-400/40 p-4 md:p-10">
              <p className="text-xl md:text-4xl font-semibold italic">
                "Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Quisquam, quod."
              </p>
            </div>
          ...
          <div className="col-span-1">
            <h5 className="text-base md:text-lg font-semibold text-center">
              SHARE ON THIS
            </h5>
